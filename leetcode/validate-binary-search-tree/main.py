...
if __name__ == '__main__':
    ...
    for i in range(test_number):
        ...
        root: TreeNode = convert_params(data[i * one_test_number + 0], 'TreeNode')
        real_res: bool = convert_params(data[i * one_test_number + 1], 'bool')

        my_res: bool = sol.isValidBST(root)
